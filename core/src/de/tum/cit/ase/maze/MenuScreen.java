...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(MazeRunnerGame game) {
        ...
        table.add(new Label("Press the button to start game!", game.getSkin(), "title")).padBottom(80).row();
        ...
        TextButton gotogamebtn = new TextButton("go to game", game.getSkin());
        table.add(gotogamebtn).width(300).row();
        ...
        //      game.setScreen(new GameScreen1(game)); // Change to the game screen when Enter key is pressed
